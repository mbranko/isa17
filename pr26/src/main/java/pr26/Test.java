...
public class Test {
  public static void main(String[] args) throws Exception {
    ...
    /* prva varijanta */
    pr26.v1.BankAccount b1 = new pr26.v1.BankAccount();
    b1.setBankName("Super Banka");
    b1.setSwift("SUBARS99");
    b1.setNumber("123456789");
    b1.setOwner("Zika");

    pr26.v1.CreditCard c1 = new pr26.v1.CreditCard();
    ...
    /* druga varijanta */
    pr26.v2.BankAccount b2 = new pr26.v2.BankAccount();
    b2.setBankName("Super Banka");
    b2.setSwift("SUBARS99");
    b2.setNumber("123456789");
    b2.setOwner("Zika");

    pr26.v2.CreditCard c2 = new pr26.v2.CreditCard();
    ...
    /* treca varijanta */
    pr26.v3.BankAccount b3 = new pr26.v3.BankAccount();
    b3.setBankName("Super Banka");
    b3.setSwift("SUBARS99");
    b3.setNumber("123456789");
    b3.setOwner("Zika");

    pr26.v3.CreditCard c3 = new pr26.v3.CreditCard();
    ...
    /* cetvrta varijanta */
    pr26.v4.BankAccount b4 = new pr26.v4.BankAccount();
    b4.setBankName("Super Banka");
    b4.setSwift("SUBARS99");
    b4.setNumber("123456789");
    b4.setOwner("Zika");

    pr26.v4.CreditCard c4 = new pr26.v4.CreditCard();
