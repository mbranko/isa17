...
class ThreadZaObraduZahteva extends Thread {

  private static final Logger logger = LoggerFactory.getLogger(ThreadZaObraduZahteva.class);
  ...
  private String successfulResponse = "<!DOCTYPE html><html><head></head><body><h1>Success</h1></body></html>";
}
